...
class QuizTests(TestCase):
    ...
    def _create_quiz(self):
        ...
        return self.client.post("/api/quizzes/", {
            "title": "Test Quiz", "description": "A test",
            "class_room": self.cls.id, "time_limit": 10, "pass_score": 50
        }, format="json")
    ...
    def test_teacher_list_quizzes(self):
        self._create_quiz()
    ...
    def test_teacher_add_question(self):
        ...
        res  = self.client.post(f"/api/quizzes/{quiz.data['id']}/add-question/", {
            "text": "What is 2+2?",
    ...
    def test_student_cannot_create_quiz(self):
        ...
        res = self.client.post("/api/quizzes/", {"title": "Hack", "class_room": self.cls.id}, format="json")
        self.assertIn(res.status_code, [403, 401])

    def test_teacher_delete_quiz(self):
        quiz = self._create_quiz()
        res  = self.client.delete(f"/api/quizzes/{quiz.data['id']}/")
